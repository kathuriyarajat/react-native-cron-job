...
public class CJService extends Service {
    ...
    private static final String CHANNEL_ID = "CRONJOB";
    ...
    private Runnable runnableCode = new Runnable() {
        ...
        public void run() {
            ...
            Intent myIntent = new Intent(context, CJEventService.class);
...
//        Intent broadcastIntent = new Intent("com.CJ.mBill.serviceRestarted");
//        sendBroadcast(broadcastIntent);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent notificationIntent = new Intent(this, CJEventService.class);
